...
Another way is to store the retrieved lines in a local buffer called `entireDoc`, and print the entire document once finished.
...
Use SODA APIs to list all document collections.
