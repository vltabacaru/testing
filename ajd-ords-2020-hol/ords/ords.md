...
This is the answer provided by AJD, in JSON format:
...
This is a nicer output. However, formatting the JSON document is not necessary for two database instances communicating via REST calls.
